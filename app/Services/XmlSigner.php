...
class XmlSigner
{
    ...
    public function sign(string $xml, Certificate $certificate): string
    {
        ...
        // Assina o XML usando o método ESTÁTICO nativo do NFePHP.
        ...
        // NFePHP retorna sem a declaração XML (LIBXML_NOXMLDECL); SEFIN exige a declaração para detectar UTF-8 (E6154).
